...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "EkspertBookerMobileApp.Android.dll" comes first in this list. */
		"EkspertBookerMobileApp.Android.dll",
		"EkspertBookerMobileApp.dll",
		"Flurl.dll",
		"Flurl.Http.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
