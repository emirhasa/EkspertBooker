...
namespace EkspertBookerMobileApp.ViewModels
{
    public class ProjektUpsertViewModel : BaseViewModel
    {
        ...
        //optimize validation with behavior or validationobject<t> etc. this is ad-hoc
       ...
       /* int _selectedKategorijaIndex;
        public int SelectedKategorijaIndex
        {
            get { return _selectedKategorijaIndex; }
            set { }
        }*/
        ...
        /*public int SelectedKategorijaIndex
        {
            get
            { 
                if(_selectedKategorija != null) return _selectedKategorija.KategorijaId;
                return 0;
            }
            set { }
        }*/
