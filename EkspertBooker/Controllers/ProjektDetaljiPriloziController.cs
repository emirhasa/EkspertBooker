...
namespace EkspertBooker.WebAPI.Controllers
{
    ...
    public class ProjektDetaljiPriloziController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get([FromQuery]ProjektDetaljiPrilogSearchRequest request)
        {
            ...
            {
                //todo: add more detailed response, try catch blocks etc.
        ...
        //[HttpPost]
        //public ActionResult<Model.ProjektDetaljiPrilog> Insert([FromBody]ProjektDetaljiPrilogUpsertRequest request)
        //{
        //    try
        //    {
        //        var entity = _mapper.Map<Database.ProjektDetaljiPrilog>(request);
        //        if (string.IsNullOrWhiteSpace(entity.PrilogNaziv))
        //            entity.PrilogNaziv = "Prilog_" + DateTime.Now.ToString("ddMMyyyy-HH:mm:ss");
        //        entity.UploadVrijeme = DateTime.Now;
        //        _context.ProjektDetaljiPrilozi.Add(entity);
        ...
        //    catch
        //    {
        //        //vjerovatno prilog vec postoji, svakako je bolje koristiti samo update(i za insert i za update priloga)  jer on u ovom slucaju adekvatnije reaguje
        //        return BadRequest();
        //    }
        //}
